...
name: Broca
role: main-agent
tools: ask_user,assign_task,bash,cron,edit_file,glob,grep,list_dir,load_skill,memory,read_file,task_management,todo_management,tree_dir,web_fetch,web_search,write_file
skills: all
