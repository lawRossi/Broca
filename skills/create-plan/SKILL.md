...
- **User-approved**: Unclear requirements, important details, and key decisions must all be clearly communicated with the user using 'ask_user'. Ask only one question at a time to avoid information overload.
