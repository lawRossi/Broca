...
class PermissionManager:
    ...
    async def request_permission(self, message: str) -> bool:
        ...
        try:
            ...
            await self._log_permission_request(message, request_id)
            ...
            async with self._permission_lock:
                ...
                await self._log_permission_response(request_id, granted)
    ...
    async def _log_permission_request(self, message: str, request_id: str):
        """
        Log permission request to database
